...
<div class="space-y-6">
	...
	>
		<div class="grid gap-6 sm:grid-cols-2">
			<div>
				<label for="name" class="mb-1 block text-sm font-medium text-dark-300"
					>Full Name</label
				>
				<input
					type="text"
			...
			<div>
				<label for="title" class="mb-1 block text-sm font-medium text-dark-300"
					>Title</label
				>
				<input
					type="text"
		...
		<div>
			<label
				for="description"
				class="mb-1 block text-sm font-medium text-dark-300">Description</label
			>
			<textarea
				id="description"
		...
		<div class="grid gap-6 sm:grid-cols-2">
			<div>
				<label for="email" class="mb-1 block text-sm font-medium text-dark-300"
					>Email</label
				>
				<input
					type="email"
			...
			<div>
				<label for="phone" class="mb-1 block text-sm font-medium text-dark-300"
					>Phone</label
				>
				<input
					type="tel"
		...
		<div>
			<label for="location" class="mb-1 block text-sm font-medium text-dark-300"
				>Location</label
			>
			<input
				type="text"
		...
		<div>
			<label
				for="avatarUrl"
				class="mb-1 block text-sm font-medium text-dark-300">Avatar URL</label
			>
			<input
				type="url"
				id="avatarUrl"
			...
			{#if profile.avatarUrl}
				<div class="mt-2 flex items-center gap-3">
					<img
						...
						alt="Avatar Preview"
						class="size-16 rounded-full object-cover border-2 border-dark-700"
					/>
		...
		<div class="grid gap-6 sm:grid-cols-3">
			<div>
				<label for="github" class="mb-1 block text-sm font-medium text-dark-300"
					>GitHub</label
				>
				<input
					type="url"
			...
			<div>
				<label
					for="linkedin"
					class="mb-1 block text-sm font-medium text-dark-300">LinkedIn</label
				>
				<input
					type="url"
					id="linkedin"
			...
			<div>
				<label
					for="twitter"
					class="mb-1 block text-sm font-medium text-dark-300">Twitter</label
				>
				<input
					type="url"
					id="twitter"
